...
const DoctorAvailability = () => {
  ...
  const handleDelete = async () => {
    try {
      ...
      const response = await axios.delete(
        `/api/doctor/delete/${scheduleToDelete._id}`,
        {
  ...
  const handleSetAvailability = async () => {
    try {
      const timeSlotsArray = newTimeSlots
        .split(",")
        .map((slot) => slot.trim())
        .filter(Boolean);
      ...
      // Append the new schedule to state
      setSchedules((prev) => [
        ...prev,
        {
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <div className="flex justify-between items-center mt-4">
            <button
              ...
              className="mb-5 bg-gray-300 text-gray-700 px-4 py-2 rounded hover:bg-gray-400"
            >
              Prev
            </button>
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-sm w-full">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                onChange={(e) =>
                  setEditTimeSlots(
                    e.target.value.split(",").map((slot) => slot.trim())
                  )
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-sm w-full">
            ...
            <div className="mb-4">
              ...
              <input
                type="text"
                value={newTimeSlots}
                onChange={(e) => setNewTimeSlots(e.target.value)}
                placeholder="e.g., 9:00AM, 10:00AM"
                className="w-full px-4 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-400"
              />
            </div>
