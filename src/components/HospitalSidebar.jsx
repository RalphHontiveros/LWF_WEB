          ...
          <ul className="flex-1 overflow-y-auto">
            <li className="mb-2">
              <Link to="/home" className="flex items-center p-2 hover:bg-gray-700 rounded">
                <FaHome className="text-xl" /> <span className={`${isOpen ? "ml-2" : "hidden"}`}>Dashboard</span>
              </Link>
            </li>
            <li className="mb-2">
              <Link to="/appointments" className="flex items-center p-2 hover:bg-gray-700 rounded">
                <FaCalendarCheck className="text-xl" /> <span className={`${isOpen ? "ml-2" : "hidden"}`}>My Appointments</span>
              </Link>
            </li>
            <li className="mb-2">
              <Link to="/sessions" className="flex items-center p-2 hover:bg-gray-700 rounded">
                <FaBookmark className="text-xl" /> <span className={`${isOpen ? "ml-2" : "hidden"}`}>My Sessions</span>
              </Link>
            </li>
            <li className="mb-2">
              <Link to="/patients" className="flex items-center p-2 hover:bg-gray-700 rounded">
                <FaUserMd className="text-xl" /> <span className={`${isOpen ? "ml-2" : "hidden"}`}>My Patients</span>
              </Link>
            </li>
            <li className="mb-2">
      ...
      {isMobile && isOpen && (
        <div className="fixed top-16 left-0 right-0 bg-gray-800 text-white p-4 flex flex-col z-50 shadow-md">
          <ul className="w-full">
            <li className="mb-2">
              <Link to="/home" className="flex items-center p-2 hover:bg-gray-700 rounded">
                <FaHome className="text-xl" /> <span className="ml-2">Dashboard</span>
              </Link>
            </li>
            <li className="mb-2">
              <Link to="/appointments" className="flex items-center p-2 hover:bg-gray-700 rounded">
                <FaCalendarCheck className="text-xl" /> <span className="ml-2">My Appointments</span>
              </Link>
            </li>
            <li className="mb-2">
              <Link to="/sessions" className="flex items-center p-2 hover:bg-gray-700 rounded">
                <FaBookmark className="text-xl" /> <span className="ml-2">My Sessions</span>
              </Link>
            </li>
            <li className="mb-2">
              <Link to="/patients" className="flex items-center p-2 hover:bg-gray-700 rounded">
                <FaUserMd className="text-xl" /> <span className="ml-2">My Patients</span>
              </Link>
            </li>
            <li className="mb-2">
              <Link to="/settings" className="flex items-center p-2 hover:bg-gray-700 rounded">
